...
ARGraph_impl::ARGraph_impl(){
	...
	in_count = NULL;  /* number of 'in' edges for each node */
	in = NULL;       /* nodes connected by 'in' edges to each node */
	in_attr = NULL;    /* Edge attributes for 'in' edges */
	out_count = NULL; /* number of 'out edges for each node */
	out = NULL;      /* nodes connected by 'out' edges to each node */
	out_attr = NULL;   /* Edge attributes for 'out' edges */
}
